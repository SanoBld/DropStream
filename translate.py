...
class GUISettingsGeneral(TypedDict):
    ...
    proxy: str
    show_inventory_tab: str
    show_inventory_tab_info: str
    ...
    "gui": {
        ...
        "settings": {
            "general": {
                ...
                "show_inventory_tab": "Show Inventory tab (requires restart): ",
                "show_inventory_tab_info": (
                    "The Inventory tab can be hidden here if you'd rather check your drops "
                    "from the web dashboard's own Inventory page instead."
                ),
            },
            "themes": {
